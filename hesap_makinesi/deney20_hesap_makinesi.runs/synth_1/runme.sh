...
HD_PWD='D:/ME/FPGA CD_rev2_1/vhdl_projeleri/deney20_hesap_makinesi/deney20_hesap_makinesi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hesap_makinasi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hesap_makinasi.tcl
