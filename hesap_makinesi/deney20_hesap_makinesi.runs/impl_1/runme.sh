...
HD_PWD='D:/ME/FPGA CD_rev2_1/vhdl_projeleri/deney20_hesap_makinesi/deney20_hesap_makinesi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hesap_makinasi.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hesap_makinasi.tcl -notrace
