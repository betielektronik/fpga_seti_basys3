...
HD_PWD='D:/ME/FPGA CD_rev2_1/dc_motor/uygulama_1/dc_motor_1/dc_motor_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dc_motor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dc_motor.tcl
