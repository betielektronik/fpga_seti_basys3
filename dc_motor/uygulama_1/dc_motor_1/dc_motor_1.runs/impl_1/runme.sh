...
HD_PWD='D:/ME/FPGA CD_rev2_1/dc_motor/uygulama_1/dc_motor_1/dc_motor_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dc_motor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dc_motor.tcl -notrace
