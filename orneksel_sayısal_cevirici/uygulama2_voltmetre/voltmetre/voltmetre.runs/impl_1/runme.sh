...
HD_PWD='D:/ME/FPGA CD_rev2_1/deney9_adc/digital_voltmetre/voltmetre/voltmetre.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log voltmetre.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source voltmetre.tcl -notrace
