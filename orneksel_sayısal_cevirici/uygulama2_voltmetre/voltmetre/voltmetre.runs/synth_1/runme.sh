...
HD_PWD='D:/ME/FPGA CD_rev2_1/deney9_adc/digital_voltmetre/voltmetre/voltmetre.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log voltmetre.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source voltmetre.tcl
