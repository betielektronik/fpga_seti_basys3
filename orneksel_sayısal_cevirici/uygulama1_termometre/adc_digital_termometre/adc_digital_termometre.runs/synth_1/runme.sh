...
HD_PWD='D:/ME/FPGA CD_rev2_1/deney9_adc/digital_termometre/adc_digital_termometre/adc_digital_termometre.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log termometre.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source termometre.tcl
