...
HD_PWD='D:/ME/FPGA CD_rev2_1/deney9_adc/digital_termometre/adc_digital_termometre/adc_digital_termometre.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log termometre.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source termometre.tcl -notrace
