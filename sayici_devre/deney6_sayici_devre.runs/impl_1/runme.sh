...
HD_PWD='D:/ME/FPGA CD_rev2_1/vhdl_projeleri/deney6_sayici_devre/deney6_sayici_devre.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sayici_devre.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sayici_devre.tcl -notrace
