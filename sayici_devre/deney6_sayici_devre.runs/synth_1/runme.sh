...
HD_PWD='D:/ME/FPGA CD_rev2_1/vhdl_projeleri/deney6_sayici_devre/deney6_sayici_devre.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sayici_devre.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sayici_devre.tcl
