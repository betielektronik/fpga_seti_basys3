...
HD_PWD='D:/ME/FPGA CD_rev2_1/deney18_elektronik_zar/elektronik_zar/elektronik_zar.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zar.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zar.tcl -notrace
