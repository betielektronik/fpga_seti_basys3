...
HD_PWD='D:/ME/FPGA CD_rev2_1/deney18_elektronik_zar/elektronik_zar/elektronik_zar.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zar.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zar.tcl
