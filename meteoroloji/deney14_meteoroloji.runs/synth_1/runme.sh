...
HD_PWD='D:/ME/FPGA CD_rev2_1/vhdl_projeleri/deney14_meteoroloji/deney14_meteoroloji.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log meteoroloji.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source meteoroloji.tcl
