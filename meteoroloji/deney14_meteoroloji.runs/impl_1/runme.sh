...
HD_PWD='D:/ME/FPGA CD_rev2_1/vhdl_projeleri/deney14_meteoroloji/deney14_meteoroloji.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log meteoroloji.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source meteoroloji.tcl -notrace
