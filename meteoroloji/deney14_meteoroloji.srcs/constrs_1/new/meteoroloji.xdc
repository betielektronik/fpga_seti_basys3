...
##Pmod Header JA
#Sch name = JA1
#set_property PACKAGE_PIN J1 [get_ports {output}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {output}]
##Sch name = JA2
#set_property PACKAGE_PIN L2 [get_ports {output1}]					
...
#Sch name = JB7
#set_property PACKAGE_PIN A15 [get_ports {FPGA_DATA}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {FPGA_DATA}]
##Sch name = JB8
#set_property PACKAGE_PIN A17 [get_ports {SCK}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {SCK}]
##Sch name = JB9
