...
HD_PWD='D:/ME/FPGA CD_rev2_1/deney16_dac/uygulama1/ramp_signal/ramp_signal.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ramp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ramp.tcl
