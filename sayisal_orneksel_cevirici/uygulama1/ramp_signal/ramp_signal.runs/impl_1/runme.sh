...
HD_PWD='D:/ME/FPGA CD_rev2_1/deney16_dac/uygulama1/ramp_signal/ramp_signal.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ramp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ramp.tcl -notrace
