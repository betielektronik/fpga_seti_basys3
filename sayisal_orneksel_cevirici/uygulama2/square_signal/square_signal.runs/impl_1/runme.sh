...
HD_PWD='D:/ME/FPGA CD_rev2_1/deney16_dac/uygulama2/square_signal/square_signal.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log square.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source square.tcl -notrace
